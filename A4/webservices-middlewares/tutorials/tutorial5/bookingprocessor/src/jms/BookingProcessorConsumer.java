...
public class BookingProcessorConsumer implements MessageListener {
    ...
    public void onMessage(Message msg) {
        try {
            ...
            if(msgText.equalsIgnoreCase("booking")) {
            	// create the producer object and send the message
                BookingProcessorProducer producer = new BookingProcessorProducer();
                try {
					producer.send("jms/mdw-cqueue", "confirmation");
				} catch (Exception e) {
    ...
    public static void main(String[] args) throws Exception {
        // input arguments
        String queueName = "jms/mdw-bqueue" ;
