...
public class OrderProcessorConsumer implements MessageListener {
    ...
    public void onMessage(Message msg) {
        try {
            ...
            if(msgText.equalsIgnoreCase("order;booking")) {
            	// create the producer object and send the message
                OrderProcessorProducer producer = new OrderProcessorProducer();
                try {
					producer.send("jms/mdw-bqueue", "booking");
				} catch (Exception e) {
					// TODO Auto-generated catch block
					e.printStackTrace();
				}
            } else if(msgText.equalsIgnoreCase("order;new trip")) {
            	// create the producer object and send the message
                OrderProcessorProducer producer = new OrderProcessorProducer();
                try {
					producer.send("jms/mdw-ntqueue", "new trip");
				} catch (Exception e) {
					// TODO Auto-generated catch block
					e.printStackTrace();
				}
