        ...
        public static List<Boutique> FiltrerBoutiquesParTypeOuBesoin(List<Boutique> boutiques, string critere, string value)
        {
            switch (critere)
            {
                ...
                case "typeBoutique":
                    ...
                    {
                        return boutiques.Where(b => b.Type == TypeBoutique.barbeAPapa).ToList();
                    }
                    else if (value.Equals("nourriture"))
                    {
                        return boutiques.Where(b => b.Type == TypeBoutique.nourriture).ToList();
                    }
                    else if (value.Equals("souvenir"))
                    {
                        return boutiques.Where(b => b.Type == TypeBoutique.souvenir).ToList();
                    }
                    else
                    {
                        return boutiques;
