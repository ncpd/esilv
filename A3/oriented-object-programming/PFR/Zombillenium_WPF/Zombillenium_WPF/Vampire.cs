...
namespace Zombillenium_WPF
{
    class Vampire : Monstre, IComparable<Vampire>
    {
        ...
        public Vampire(int matricule, string nom, string prenom, string genre, string fonction, int cagnotte, string affectation, double luminosite) : base(matricule, nom, prenom, genre, fonction, cagnotte, affectation)
        {
            this.IndiceLuminosite = luminosite;
        }
